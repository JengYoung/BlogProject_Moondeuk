...
const UpdateInputWrapper = ({ comment_id, onUpdate, onIsUpdateMode, onChangeText, updatedContent }) => {
    const onClick = () => {
        onIsUpdateMode();
        onUpdate();
    }
    ...
    return (
        <StyledUpdateInputWrapper>
            <StyledUpdateInput onChange={onChange} name="updatedContent" value={updatedContent[comment_id]}/>
